          ...
          <div className="mt-6 mb-2 text-center">
            ...
            <button
              ...
              className={`inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium rounded-lg transition-colors
                          bg-yellow-400 hover:bg-yellow-500 dark:bg-yellow-700 dark:hover:bg-yellow-600 text-yellow-900 dark:text-yellow-100 focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:focus:ring-yellow-600 focus:ring-offset-2 dark:focus:ring-offset-gray-800
